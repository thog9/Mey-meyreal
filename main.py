...
╚═╝░░░░░╚═╝╚══════╝░░░╚═╝░░░  ╚═╝░░░░░╚═╝╚══════╝░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝╚══════╝
    ...
    print_border("MEY MEYREAL", Fore.GREEN)
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            {"name": "1. Tự động hoàn thành nhiệm vụ Boost Priority ( Login X )", "value": "socialX"},
            
            {"name": "X. Thoát", "value": "exit"},
        ],
        'en': [
            {"name": "1. Automatic task Boost Priority ( Login X )", "value": "socialX"},
